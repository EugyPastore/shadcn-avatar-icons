...
magick png/512/shadcn-avatar-{a,b,c,d,e,f}.png -filter Lanczos -resize 320x320 +repage \
  -background none -bordercolor none -border 64x0 +repage +append -bordercolor none -border 32x96 +repage assets/preview-light.png
